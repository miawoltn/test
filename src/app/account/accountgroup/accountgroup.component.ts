...
export class AccountgroupComponent implements OnInit {
	...
	displayedColumns: string[] = ['AccountGroup'];
	data = [];
    obj={ AccountGroup : null };
    displayForm = false;
    operation = "Add";
	title="Accountgroup";
	parent="account";
    ...
    processForm()
    {
      let url = accountUrl.accountgroup.add;
      if(this.operation=="Update")
        url = accountUrl.accountgroup.update;
      this.save(url);
    }
