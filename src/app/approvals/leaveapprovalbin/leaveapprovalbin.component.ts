...
@Component({
  selector: 'app-leaveapprovalbin',
  templateUrl: './leaveapprovalbin.component.html',
  styleUrls: ['./leaveapprovalbin.component.scss']
})
export class LeaveapprovalbinComponent implements OnInit {
  isEditable = true;
  isLinear = true;
  data = [];
  obj = {
