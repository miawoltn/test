...
export class EmployeeEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get(employeeUrl.employee.employeeInfo + 29).subscribe(
      (res) => {
        console.log(res.data);
        this.obj = res.data.employee;
        if (res.data.empParents == false) {
          this.obj2 = [
            {
              FullName: null,
              RelationshipID: null,
          ...
          // this.obj2 = res.data.empParents;
        }

        if (res.data.empEdu == false) {
          this.obj3 = [
            {
              Description: null,
              SchoolName: null,
        ...
        if (res.data.empGuarantor == false) {
          this.obj4 = [
            {
              GuarantorName: null,
              Address: null,
          ...
          // this.obj4 = res.data.empGuarantor;
        }

        if (res.data.empWork == false) {
          this.obj5 = [
            {
              EmployeeID: null,
              EmployeeName: null,
          ...
          // this.obj5 = res.data.empWork;
        }

        if (res.data.empDependent == false) {
          this.obj6 = [
            {
              Surname: null,
              FirstName: null,
          ...
          // this.obj6 = res.data.empDependent;
        }

        if (res.data.empHealth == false) {
          this.obj7 = [
            {
              HealthInsuranceProviderID: null,
              HealthInsuranceProvider: null,
          ...
          // this.obj7 = res.data.empHealth;
        }

        if (res.data.empReferee == false) {
          this.obj8 = [
            {
              FullName: null,
              Address: null,
  ...
  onConfirm() {
    ...
    for (let i = 0; i < this.obj3.length; i++) {
      ...
      for (let i = 0; i < this.obj7.length; i++) {
        this.obj7[
          i
        ].HealthInsuranceProvider = this.healthinsuranceproviders.find(
          (item) =>
