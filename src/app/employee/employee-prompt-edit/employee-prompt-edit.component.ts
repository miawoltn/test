...
@Component({
  selector: 'app-employee-prompt-edit',
  templateUrl: './employee-prompt-edit.component.html',
  styleUrls: ['./employee-prompt-edit.component.css'],
})
export class EmployeePromptEditComponent implements OnInit {
  ...
  employeeProfile() {
    this.http.get(employeeUrl.employee.employeeProfile).subscribe(
      (res) => {
        ...
        this.obj5 = res.data.empworkhistory;
        this.obj3 = res.data.empedu;
        this.obj2 = res.data.empfam;
  ...
  processForm() {
    let url = employeeUrl.employee.promptUpdate;
    this.save(url);
  }
