...
@Component({
  selector: 'app-hr-approval-bin',
  templateUrl: './hr-approval-bin.component.html',
  styleUrls: ['./hr-approval-bin.component.css']
})
export class HrApprovalBinComponent implements OnInit {
  ...
  leaveInfo = {
    ...
    ContactAddress: null, handover: null
  };
  Employee: any;
  ...
  ngOnInit() {
    ...
    this.http.get(approvalUrl.approvalinstances.HrApprovalInstances)
      .subscribe(res => {
        console.log(res.data);
