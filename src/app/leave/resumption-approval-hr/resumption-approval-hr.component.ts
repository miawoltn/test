...
@Component({
  selector: 'app-resumption-approval-hr',
  templateUrl: './resumption-approval-hr.component.html',
  styleUrls: ['./resumption-approval-hr.component.css']
})
export class ResumptionApprovalHrComponent implements OnInit {
