...
@Component({
  selector: "app-jobinterview-details-view-not-commended",
  templateUrl: "./jobinterview-details-view-not-commended.component.html",
  styleUrls: ["./jobinterview-details-view-not-commended.component.scss"],
})
export class JobinterviewDetailsViewNotRecommendedComponent implements OnInit {
  ...
  ApplicantID: any;
  constructor(protected http: HttpService, private uploadService: UploadService, protected dialog: MatDialog) {
  ...
  jobOfferBin() {
    this.http.get(recruitmentUrl.jobinterviewdetail.notRecommended).subscribe(
      (res) => {
        this.data = res.data;
      },
      (err) => {
