...
@Component({
    selector: 'app-jobshortlist-details-view',
    templateUrl: './jobshortlist-details-view.component.html',
    styleUrls: ['./jobshortlist-details-view.component.scss'],
})
export class JobshortlistDetailsViewComponent implements OnInit {
